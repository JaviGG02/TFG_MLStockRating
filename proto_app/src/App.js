...
function App() {
  ...
  const buscarTicker = (ticker) => {
    fetch("http://localhost:5000/api/datos", {
      ...
      .catch((error) => {
        // Error en frontend o backend
        console.error("Error:", error);
        setData({
          ...data,
          cargando: false,
          mensajeError: "An error occured while loading the data",
        });
      });
  };
      ...
      {data.cargando ? (
        ...
        <>
          ...
          data.calificacion !== null ? (
            <>
              <OverviewComponent
                overview={data.datosFinancieros.OVERVIEW}
              ...
              <div className="page-container">
                ...
                <div className="table-container">
                  <FinancialTable
                    incomeStatement={
                      data.datosFinancieros.INCOME_STATEMENT.annualReports
                    }
                    balanceSheet={
                      data.datosFinancieros.BALANCE_SHEET.annualReports
                    }
